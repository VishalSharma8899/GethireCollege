...
  return (
    <div className="bg-gradient-to-r bg-white  w-64 h-28 rounded-xl mt-3 ml-14 flex gap-10 hover:translate-x-2 hover:shadow-2xl transition-transform duration-300">
    <div className="mt-2">
...
      />
       <div
      className="mt-1 w-20 rounded-full bg-blue-500 hover:bg-blue-700 shadow-md px-4 py-1"
    >
